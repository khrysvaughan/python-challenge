...
with open(resourcefile, newline="") as csvfile:
    ...
    print(f"Average Change: ${str(round(avgmonths,2))}")
    ...
    print(f"Greatest Increase in Profits: {greatincmonth} (${str(greatincvalue)})")
    ...
    print(f"Greatest Decrease in Profits: {greatdecmonth} (${str(greatdecvalue)})")
